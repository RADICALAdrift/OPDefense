...
{
    public class HappyBDayBeam : ModProjectile
    {
		...
		{
			DisplayName.SetDefault("HappyBDayBeam");
		}
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 2; ++i)
            {
                ...
                Dust dust = Main.dust[Dust.NewDust(_targetPos, 0, 0, 235, dustVel.X, dustVel.Y, 0, new Color(), 18f)];  //this is the head dust
                Dust dust2 = Main.dust[Dust.NewDust(_targetPos, 0, 0, 235, dustVel.X, dustVel.Y, 0, new Color(), 18f)]; //this is the head dust 2
                dust.noGravity = true;
                dust.scale = 1.2f;
            }
