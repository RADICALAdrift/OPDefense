...
{
    public class GODHappyBDayBeam : ModItem
    {
        public override void SetDefaults()
        {
            item.damage = 33333;  //The damage stat for the Weapon.
            ...
            item.shoot = mod.ProjectileType("HappyBDayBeam");  //This defines what type of projectile this weapon will shoot  
    ...
    {
      DisplayName.SetDefault("Happy Birthday OPDefense");
      Tooltip.SetDefault("OPDefense's 3rd BDay Celebration");
    }
